...
router.get('/get_total_data/:id', getTotalAggregateById);           // get employee data on today, this week, and this month
...
/* 
    salary list router
*/
router.post('/calculate/:id', calculate);                               //calculate salary by formula
